...
public record McpCaller(PrincipalKey principal, String clientId, Set<String> scopes) {
    ...
    public static McpCaller from(McpTransportContext context) {
        ...
        return new McpCaller(new PrincipalKey(URI.create(issuer), subject), clientId, scopes);
    }
