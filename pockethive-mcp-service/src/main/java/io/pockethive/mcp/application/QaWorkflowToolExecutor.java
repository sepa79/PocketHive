...
/**
 * Responsibility: Dispatch MCP-owned QA tools to their single bounded application handler. Must
 * not: Implement session, workflow, bundle, persistence, or projection behavior. Contract:
 * docs/mcp/README.md.
 */
@Component
