 ...
 * <p>
 * Responsibility: construct test identities, topology and properties through canonical factories.
 * Must not: duplicate routing/validation or enter a production runtime classpath.
 * Contract: RESP-TEST-WORK-FIXTURES — docs/architecture/runtime-responsibilities.md#resp-test-work-fixtures.
 */
