...
/**
 * Responsibility: declare Artemis output transport settings as startup-only.
 ...
 */
public final class ArtemisOutputMutationPolicy implements WorkOutputMutationPolicy {
