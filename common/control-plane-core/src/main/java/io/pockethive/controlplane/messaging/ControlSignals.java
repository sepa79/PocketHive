...
public final class ControlSignals {
    ...
    public static ControlSignal swarmCreate(String origin,
        ...
        return signal(ControlPlaneSignals.SWARM_CREATE, origin, target, correlationId, idempotencyKey, runtime, data);
    }
    ...
    public static ControlSignal swarmControllerReady(String origin,
                                                     ...
                                                     String idempotencyKey,
                                                     Map<String, Object> runtime) {
        return signal("swarm-controller", origin, target, correlationId, idempotencyKey, runtime, null);
    }
    ...
    public static ControlSignal swarmTemplate(String origin,
                                              ...
                                              Map<String, Object> runtime,
                                              Map<String, Object> data) {
        return signal(ControlPlaneSignals.SWARM_TEMPLATE, origin, target, correlationId, idempotencyKey, runtime, data);
    }
    ...
    public static ControlSignal swarmPlan(String origin,
                                          ...
                                          Map<String, Object> runtime,
                                          Map<String, Object> data) {
        return signal(ControlPlaneSignals.SWARM_PLAN, origin, target, correlationId, idempotencyKey, runtime, data);
    }
    ...
    public static ControlSignal swarmStart(String origin,
                                           ...
                                           String idempotencyKey,
                                           Map<String, Object> runtime) {
        return signal(ControlPlaneSignals.SWARM_START, origin, target, correlationId, idempotencyKey, runtime, null);
    }
    ...
    public static ControlSignal swarmStop(String origin,
                                          ...
                                          String idempotencyKey,
                                          Map<String, Object> runtime) {
        return signal(ControlPlaneSignals.SWARM_STOP, origin, target, correlationId, idempotencyKey, runtime, null);
    }
    ...
    public static ControlSignal swarmRemove(String origin,
                                            ...
                                            String idempotencyKey,
                                            Map<String, Object> runtime) {
        return signal(ControlPlaneSignals.SWARM_REMOVE, origin, target, correlationId, idempotencyKey, runtime, null);
    }
    ...
    public static ControlSignal statusRequest(String origin,
                                              ...
                                              String idempotencyKey,
                                              Map<String, Object> runtime) {
        return signal(ControlPlaneSignals.STATUS_REQUEST, origin, target, correlationId, idempotencyKey, runtime, null);
    }
    ...
    public static ControlSignal configUpdate(String origin,
        ...
        return signal(ControlPlaneSignals.CONFIG_UPDATE, origin, target, correlationId, idempotencyKey, runtime, args);
    }
