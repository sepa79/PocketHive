...
- Queen panel: create new swarms by providing an ID and choosing a template; each swarm spawns a Marshal to set up queues and bee containers.
...
- **Queen view** — form for launching swarms by ID and template; starting a swarm spins up a Marshal controller.
