...
class ModeratorControlPlaneConfig {
  ...
  @ConditionalOnMissingBean(name = "moderatorControlPlaneEmitter")
  ControlPlaneEmitter moderatorControlPlaneEmitter(
      @Qualifier("workerControlPlaneIdentity") ControlPlaneIdentity identity,
      ControlPlanePublisher publisher) {
    Objects.requireNonNull(identity, "identity");
    Objects.requireNonNull(publisher, "publisher");
    return ControlPlaneEmitter.moderator(identity, publisher);
  }

  @Bean(name = "moderatorControlQueueName")
  @ConditionalOnMissingBean(name = "moderatorControlQueueName")
  String moderatorControlQueueName(
