...
> Original path: `docs/todo/workitem-transport-agnostic.md`.
> Envelope migration history/remaining ideas must not compete with the existing canonical WorkItem schema and codec.
