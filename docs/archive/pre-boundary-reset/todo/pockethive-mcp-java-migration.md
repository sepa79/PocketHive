...
> Original path: `docs/todo/pockethive-mcp-java-migration.md`.
> Implemented migration/acceptance record, not future work. Remote rollout remains a separate governed operation.
