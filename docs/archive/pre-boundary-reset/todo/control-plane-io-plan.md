...
> Original path: `docs/todo/control-plane-io-plan.md`.
> Proposes Control Plane ownership of Work IO configuration, conflicting with Work-owned contracts consumed by Control Plane.
