...
> Original path: `docs/todo/config-key-normalisation-plan.md`.
> Transport/configuration normalization must follow the canonical contract owner; standalone migration sequencing is superseded.
...
> Backlog plan; this work has not started yet.
