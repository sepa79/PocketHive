...
> Original path: `docs/todo/pockethive-intellij-plugin.md`.
> Proposes unsupported stdio/local spawning and backend configuration; any revived IDE proposal must use current Java MCP ingress.
