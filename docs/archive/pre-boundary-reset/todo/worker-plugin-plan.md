...
> Original path: `docs/todo/worker-plugin-plan.md`.
> Plugin hosts and multi-worker packaging are deferred; the old SDK rollout is not this stream’s implementation plan.
