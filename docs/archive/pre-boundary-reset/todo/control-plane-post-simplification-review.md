...
> Original path: `docs/todo/control-plane-post-simplification-review.md`.
> Dated CP evidence; unresolved CP-N02–CP-N09 are carried into the active plan, while CP-N01 is committed.
