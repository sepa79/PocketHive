...
> Original path: `docs/todo/http-request-processor-plan.md`.
> Richer HTTP execution and concurrency proposals are deferred until the Work runtime contract is established.
...
> `common/worker-sdk/README.md`, and the current `WorkItem`/steps model.
