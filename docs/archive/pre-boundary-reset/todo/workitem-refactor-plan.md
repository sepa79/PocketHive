...
> Original path: `docs/todo/workitem-refactor-plan.md`.
> Retains obsolete WorkMessage/WorkResult migration instructions and mixed completed/future stages.
...
> and `docs/archive/pre-boundary-reset/todo/http-request-processor-plan.md`.
...
> Stage 3 ties directly into `docs/archive/pre-boundary-reset/todo/http-request-processor-plan.md`.
