...
> Original path: `docs/plugins/pockethive/BUNDLE-WIZARD.md`.
...
| `docs/archive/pockethive-plugin/IMPLEMENTATION-GUIDE.md` §10 | Historical `bundle.scaffold` implementation notes |
