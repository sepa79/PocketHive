...
> Original path: `docs/plugins/pockethive/AGENT-RULES.md`.
> Historical or deferred design; current architecture/MCP contracts and the active module-boundary plan take precedence.
...
| Plugin reference | `docs/archive/pre-boundary-reset/plugins/pockethive/` (this folder) |
| **Plugin docs index** | `docs/archive/pre-boundary-reset/plugins/pockethive/README.md` |
| **MCP tool contracts** | `docs/archive/pre-boundary-reset/plugins/pockethive/TOOL-CONTRACTS.md` |
| **Evidence taxonomy** | `docs/archive/pre-boundary-reset/plugins/pockethive/EVIDENCE.md` |
| **Developer setup** | `docs/archive/pre-boundary-reset/plugins/pockethive/DEVELOPER-SETUP.md` |
| **Historical build decisions** | `docs/archive/pockethive-plugin/BUILD-READY-GAPS.md` |
...
| Agent context switches | `env.switch` and `context.set-bundles-root` trigger toast notifications with Undo (historical review: `docs/archive/pockethive-plugin/UX-FIXES.md`) |
