...
> Status: implemented PocketHive baseline / archived  
> Scope: PocketHive deployment boundary, UI V2, Scenario Manager, Orchestrator, PocketHive-specific permissions  
> Remaining authorization evolution is tracked in `docs/todo/auth-service-followups.md`.
...
2. `docs/scenarios/SCENARIO_EDITOR_STATUS.md`
