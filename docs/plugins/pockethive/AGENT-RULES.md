...
| Plugin reference | `docs/plugins/pockethive/` (this folder) |
| **Plugin docs index** | `docs/plugins/pockethive/README.md` |
| **MCP tool contracts** | `docs/plugins/pockethive/TOOL-CONTRACTS.md` |
| **Evidence taxonomy** | `docs/plugins/pockethive/EVIDENCE.md` |
| **Developer setup** | `docs/plugins/pockethive/DEVELOPER-SETUP.md` |
