...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
  ...
  context.subscriptions.push(
    ...
    vscode.commands.registerCommand('pockethive.startSwarmMcp', (target: unknown) => startSwarmMcp(target, hiveProvider)),
    vscode.commands.registerCommand('pockethive.stopSwarmMcp', (target: unknown) => stopSwarmMcp(target, hiveProvider)),
