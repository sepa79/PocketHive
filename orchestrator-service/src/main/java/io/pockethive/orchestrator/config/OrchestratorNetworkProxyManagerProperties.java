...
/**
 * Responsibility: Bind the Network Proxy Manager client connection settings.
 * Must not: Resolve control-plane topology or provision runtime resources.
 * Contract: docs/orchestrator/configuration.md.
 */
@Validated
public final class OrchestratorNetworkProxyManagerProperties {

    private final String url;
    private final @Valid OrchestratorHttpProperties http;

    public OrchestratorNetworkProxyManagerProperties(@NotBlank String url, @Valid OrchestratorHttpProperties http) {
