...
1. **[START-HERE.md](START-HERE.md)** - Current navigation and qualification status
...
4. **[WIREMOCK-PARITY.md](WIREMOCK-PARITY.md)** - Canonical TCP capability qualification
...
9. **[EXECUTIVE-SUMMARY.md](EXECUTIVE-SUMMARY.md)** - Project summary and decisions

### Operations status
10. **[DOCUMENTATION-STATUS.md](DOCUMENTATION-STATUS.md)** - Documentation and handover status
...
3. EXECUTIVE-SUMMARY.md - Project decisions
...
[START-HERE.md](START-HERE.md) provides navigation.
[WIREMOCK-PARITY.md](WIREMOCK-PARITY.md) owns capability qualification and
acceptance requirements. Other guides retain historical, unverified examples;
their old dates, checkmarks and filenames do not certify runtime support.

## Source of truth

Module Markdown is maintained under
`tcp-mock-server/docs/`; packaged runtime copies are generated by the build.
