...
- UI: Restore HAL eye status indicators and hamburger menu button.
...
- UI: Swap menu for monolith icon, remove HAL eyes, and refresh radar and connection buttons with new health indicator.
